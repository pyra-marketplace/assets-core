...
contract DeployDataToken is Script {
    address dappTableRegistry = 0x0Fa654E438163c899549acaB863178205607A88F;
    ...
    function run() public {
        ...
        ActionConfig actionConfig = new ActionConfig(vm.addr(deployerPrivateKey), dappTableRegistry, protocolTreasury, protocolFeePoint);
        vm.stopBroadcast();
